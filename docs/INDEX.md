...
{% include button.html text="Return to Home" link="./" style="primary" %}
{% include button.html text="View on GitHub" link="https://github.com/ITlusions/ITL.ControlPlane.Attestation" style="secondary" target="_blank" %}
</div>
